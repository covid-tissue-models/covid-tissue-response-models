...
write_med_diff_data_freq = 1  # Write total diffusive field amount frequency (disable with 0)
plot_ir_data_freq = 0  # Plot immune recruitment data frequency (disable with 0)
write_ir_data_freq = 1  # Write immune recruitment data to simulation directory frequency (disable with 0)
plot_spat_data_freq = 0  # Plot spatial data frequency (disable with 0)
write_spat_data_freq = 1  # Write spatial data to simulation directory frequency (disable with 0)
