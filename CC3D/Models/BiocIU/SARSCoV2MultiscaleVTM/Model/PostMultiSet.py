...
dir_spatial_results_root_abs = r'H:\My Drive\ddm-review\0.5_delay'
# dir_spatial_results_root_abs = r'D:\Google Drive IU\phdStuff\covid 19 project\ddm results\simple-pk\nothing_10'
...
rate_mult = 1 / 2
rate = rate_mult * 30.4
dir_spatial_results_rel = get_sets_of_param_value('first_dose', 0.5
                                                  , inputs)  # append to this to add the 5th line
# dir_spatial_results_rel = ['set_9', 'set_11']
# dir_spatial_results_rel = dir_spatial_results_rel[100:]
...
dir_root_output_abs = os.path.join(r'D:\Google Drive IU\phdStuff\covid 19 project\ddm results\simple-pk',
                                   'longer_period', 'redone_intercell_var',  'first_dose_3')
dir_root_output_abs = r'H:\My Drive\ddm-review\analysed_data\0.5'
# dir_root_output_abs = os.path.join(r'D:\Google Drive IU\phdStuff\covid 19 project\ddm results\simple-pk',
#                                    'macro_var')
# dir_root_output_abs = os.path.join(r'D:\Google Drive IU\phdStuff\covid 19 project\ddm results\simple-pk',
...
if __name__ == '__main__':
    ...
    for set_idx in range(len(dir_spatial_results_rel)):
        ...
        for k in batch_data_s.keys():
            # print(k)
            if "batchMean" in batch_data_s[k].keys():
                batch_data_s[k].pop("batchMean")
            if "batchStDev" in batch_data_s[k].keys():
                batch_data_s[k].pop("batchStDev")
            # batch_data_s[k]["ODE"] = batch_data_o[k][0]
        # for k in batch_data_s:
        #     for t in  batch_data_s[k].keys():
        #         if batch_data_s[k][t] is None:
        #             print(results_dir, k, t)
        #         elif len(batch_data_s[k][t].keys()) < 8001:
        #             print(results_dir, k, t)
        # continue
        # Trim
        for k in batch_data_s:
