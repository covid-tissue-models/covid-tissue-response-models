...
__param_desc__ = {
    ...
    'exp_translating_rate': 'Translating rate',
    'exp_packing_rate': 'Packing rate',
    'exp_secretion_rate': 'Secretion rate',
    'exp_virus_dc': 'Viral diffusion coefficient',
    'exp_cytokine_dc_w': 'Cytokine extracellular diffusion coefficient',
    'exp_cytokine_dc_cyto': 'Cytokine intracellular diffusion coefficient',
    'exp_max_ck_diff_len': 'Cytokine diffusion length',
    'exp_min_ck_decay': 'Cytokine decay coefficient',
    'exp_max_cytokine_consumption': 'Maximum cytokine consumption',
    'exp_max_cytokine_immune_secretion': 'Maximum cytokine immune secretion rate',
    'exp_max_cytokine_consumption_mol': 'Cytokine immune uptake rate',
    'exp_max_cytokine_immune_secretion_mol': 'Maximum cytokine lung tissue secretion rate',
    'exp_EC50_cytokine_immune': 'Immune cell cytokine activation',
    'minimum_activated_time_seconds': 'Immune cell equilibrium bound cytokine',
    'exp_max_amount_viral_mRNA': '',
    'exp_oxi_dl': 'Oxidation Agent diffusion length',
    'exp_oxi_dc_water': 'Oxidation Agent extracellular diffusion coefficient',
    'exp_oxi_dc_cyto': 'Oxidation Agent intracellular diffusion coefficient',
    'cell_diameter': 'Unitless cell diameter',
    'cell_volume': 'Unitless cell volume',
    'virus_dc': 'Unitless virus diffusion coefficient',
    'virus_dl': 'Unitless virus diffusion length',
    'virus_decay': 'Unitless virus decay coefficient',
    'unpacking_rate': 'Unitless unpacking rate',
    'replicating_rate': 'Unitless replicating rate',
    'translating_rate': 'Unitless translating rate',
    'packing_rate': 'Unitless packing rate',
    'secretion_rate': 'Unitless secretion rate',
    'cytokine_dc': 'Unitless cytokine diffusion coefficient',
    'cytokine_field_decay': 'Unitless cytokine decay coefficient',
    'max_ck_consume': 'Unitless maximum cytokine consumption',
    'max_ck_secrete_im': 'Unitless maximum cytokine immune secretion rate',
    'max_ck_secrete_infect': 'Unitless maximum cytokine lung tissue secretion rate',
    'EC50_ck_immune': 'Unitless immune cell cytokine activation',
    'ck_equilibrium': 'equilibrium amount of ck in immune surface',
    'ck_memory_immune': '1 - Immune cell bound cytokine memory',
    'minimum_activated_time': 'Unitless immune cell equilibrium bound cytokine',
    'ec50_infecte_ck_prod': 'Amount of internal assembled virus to be at 50% cytokine production',
    'oxi_dl': 'Unitless Oxidation Agent diffusion length',
    'oxi_dc': 'Unitless Oxidation Agent diffusion coefficient',
    'oxi_decay': 'Unitless Oxidation Agent decay coefficient',
    ...
    'relative_viral_uptake': 'Efficiency of viral uptake',
    'initial_immune_seeding': 'Number of immune cells to seed at the beginning of the simulation',
    'bystander_effect': 'Probability rate of death due to the Bystander Effect',
    'lamda_chemotaxis': 'Lambda chemotaxis (chemotactic sensitivity)',
    'vr_step_size': 'Antimony/SBML model step size',
    'exp_kon': 'Virus-receptors association affinity',
    'exp_koff': 'Virus-receptors disassociation affinity',
    'initial_unbound_receptors': 'Initial number of receptors on the cell surface',
    'r_half': 'Number of cell receptors at which the replication rate is half of maximum',
    'kon': 'Unitless virus-receptors association affinity',
    'koff': 'Unitless virus-receptors disassociation affinity',
    'ir_add_coeff': 'Immune response rate addition coefficient',
    'ir_subtract_coeff': 'Immune response rate subtraction coefficient',
    'ir_delay_coeff': 'Immune response rate delay coefficient',
    'ir_decay_coeff': 'Immune response rate decay coefficient',
    'ir_transmission_coeff': 'Immune response cytokine transmission coefficient',
    'ir_prob_scaling_factor': 'Immune response probability scaling coefficient'
}
